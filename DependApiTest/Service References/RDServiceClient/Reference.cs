...
namespace DependApiTest.RDServiceClient {
    ...
    public partial class ReturnInfo : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private DependApiTest.RDServiceClient.ErrorInfo ErrorInfoField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private bool HasErrorField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private DependApiTest.RDServiceClient.IDInfo[] IDInfoField;
        ...
        public DependApiTest.RDServiceClient.ErrorInfo ErrorInfo {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public DependApiTest.RDServiceClient.IDInfo[] IDInfo {
            get {
    ...
    public partial class QueryParams : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private DependApiTest.RDServiceClient.Pair[] PARAMSField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public DependApiTest.RDServiceClient.Pair[] PARAMS {
            get {
    ...
    public partial class AuditReference : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private DependApiTest.RDServiceClient.AuditDocument[] DocumentField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public DependApiTest.RDServiceClient.AuditDocument[] Document {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="HTTP://WWW.PERCIVAL.CO.UK/ML7", ConfigurationName="RDServiceClient.IRDService")]
    public interface IRDService {
        ...
        DependApiTest.RDServiceClient.ReturnInfo WebLogin(out string sessionId, string user, string password, string clientVersion);
        ...
        DependApiTest.RDServiceClient.ReturnInfo RegardLogin(out string sessionId, string user, string password, string clientVersion);
        ...
        DependApiTest.RDServiceClient.ReturnInfo DependLogin(out string sessionId, string user, string password, string clientVersion, string participant);
        ...
        DependApiTest.RDServiceClient.ReturnInfo Logout(string sessionId);
        ...
        DependApiTest.RDServiceClient.ReturnInfo LoginChangeWorkgroup(string sessionId, int workgroupId);
        ...
        DependApiTest.RDServiceClient.ReturnInfo DataSetListZIP(out string schema, out byte[] data, string sessionId, string name, int top, string where);
        ...
        DependApiTest.RDServiceClient.ReturnInfo DataSetList(out string schema, out string data, string sessionId, string name, int top, string where);
        ...
        DependApiTest.RDServiceClient.ReturnInfo DataSetUpdate(ref int auditId, string sessionId, string name, int batchId, string data, string auditReference);
        ...
        DependApiTest.RDServiceClient.ReturnInfo DataSetUpdateZIP(ref int auditId, string sessionId, string name, int batchId, byte[] data, string auditReference);
        ...
        DependApiTest.RDServiceClient.ReturnInfo DataSetConfirm(int auditId, string sessionId, string auditReference);
        ...
        DependApiTest.RDServiceClient.ReturnInfo DataSetReject(int auditId, string sessionId, string auditReference);
        ...
        DependApiTest.RDServiceClient.QueryParams[] GetOptions();
        ...
        DependApiTest.RDServiceClient.AuditReference DefineAuditReference();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRDServiceChannel : DependApiTest.RDServiceClient.IRDService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RDServiceClient : System.ServiceModel.ClientBase<DependApiTest.RDServiceClient.IRDService>, DependApiTest.RDServiceClient.IRDService {
        ...
        public DependApiTest.RDServiceClient.ReturnInfo WebLogin(out string sessionId, string user, string password, string clientVersion) {
            return base.Channel.WebLogin(out sessionId, user, password, clientVersion);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo RegardLogin(out string sessionId, string user, string password, string clientVersion) {
            return base.Channel.RegardLogin(out sessionId, user, password, clientVersion);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo DependLogin(out string sessionId, string user, string password, string clientVersion, string participant) {
            return base.Channel.DependLogin(out sessionId, user, password, clientVersion, participant);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo Logout(string sessionId) {
            return base.Channel.Logout(sessionId);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo LoginChangeWorkgroup(string sessionId, int workgroupId) {
            return base.Channel.LoginChangeWorkgroup(sessionId, workgroupId);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo DataSetListZIP(out string schema, out byte[] data, string sessionId, string name, int top, string where) {
            return base.Channel.DataSetListZIP(out schema, out data, sessionId, name, top, where);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo DataSetList(out string schema, out string data, string sessionId, string name, int top, string where) {
            return base.Channel.DataSetList(out schema, out data, sessionId, name, top, where);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo DataSetUpdate(ref int auditId, string sessionId, string name, int batchId, string data, string auditReference) {
            return base.Channel.DataSetUpdate(ref auditId, sessionId, name, batchId, data, auditReference);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo DataSetUpdateZIP(ref int auditId, string sessionId, string name, int batchId, byte[] data, string auditReference) {
            return base.Channel.DataSetUpdateZIP(ref auditId, sessionId, name, batchId, data, auditReference);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo DataSetConfirm(int auditId, string sessionId, string auditReference) {
            return base.Channel.DataSetConfirm(auditId, sessionId, auditReference);
        }
        
        public DependApiTest.RDServiceClient.ReturnInfo DataSetReject(int auditId, string sessionId, string auditReference) {
            return base.Channel.DataSetReject(auditId, sessionId, auditReference);
        }
        
        public DependApiTest.RDServiceClient.QueryParams[] GetOptions() {
            return base.Channel.GetOptions();
        }
        
        public DependApiTest.RDServiceClient.AuditReference DefineAuditReference() {
